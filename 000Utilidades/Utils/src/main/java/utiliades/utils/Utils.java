...
public class Utils {
    ...
    public static void main(String[] args) {
        ...
        // System.out.println(numerin);
        // numerin = Utilidades.leerInt("Introduce un número(Solo numeros positivos): ",
        // true);
        // double decimal;
        // decimal = Utilidades.leerDouble("Introduce un número decimal(Sin
        // restricciones): ");
        // System.out.println(decimal);
        // decimal = Utilidades.leerDouble("Introduce un número decimal(entre 5 y 15):
        // ", 5.0, 15.0);
        // System.out.println(decimal);
